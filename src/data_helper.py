...
def create_dataloaders(args, ispertrain):
    if ispertrain:
        dataset = MultiModalDataset(args, args.unlable_ann, args.unlable_zip_feats, ispertrain)
    else:
        dataset = MultiModalDataset(args, args.train_annotation, args.train_zip_feats, ispertrain)
    size = len(dataset)
